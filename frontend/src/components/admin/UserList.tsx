...
import { adminUserList } from '../../services/api/admin/apiMethods';
      ...
      <table className=" w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th scope="col" className="px-6 py-4 font-medium text-gray-900">Google</th>
            <th scope="col" className="px-6 py-4 font-medium text-gray-900">Facebook</th>
        ...
        {users.length>0 && users.map((user: any) => (
          ...
          <tr key={user._id} className="hover:bg-gray-50">
            ...
            <td className="px-6 py-4">{user.isFacebook?(<span className="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-xs font-semibold text-blue-600">
            Yes
                </span>):'No'}</td>

            <td className="px-6 py-4">{user.isBlocked?(<span className="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-xs font-semibold text-red-600">
            Blocked
            ...
            <td className="px-6 py-4">
              ...
              {user.isBlocked?(<button type="button" className=" bg-white text-blue-600 hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2">
                <CheckCheck />UnBlock
