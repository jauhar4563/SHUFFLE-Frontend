function Posts() {
  return (
    <>
      <div className="lg:col-span-2 ms-10 w-5/12 p-4 bg-white mt-3" id="posted">
        <div className="flex flex-col">
          <div className="bg-white p-8 mb-4 rounded-lg shadow-md max-w-full">
          ...
          <div className="bg-white p-8 rounded-lg mb-4  shadow-md max-w-full">
            {/* User Info with Three-Dot Menu */}
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-2">
                <img
