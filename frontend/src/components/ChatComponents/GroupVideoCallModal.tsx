...
import Ringtone from '../../assets/audio/ringtoneVideoCall.mp3';

const GroupVideoCallModal = ({ show, onHide, onAccept, onReject, caller }) => {
    useEffect(() => {
        const audio = new Audio(Ringtone); // Replace '/path/to/sound.mp3' with the actual path to your sound file
        if (show) {
          audio.play();
        }
        return () => {
